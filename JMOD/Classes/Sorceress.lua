...
--[[ ACT 1 ]]--
Config.Scripts.Corpsefire.Enabled			  = false
Config.Scripts.Corpsefire.ClearDen			  = false
...
Config.Scripts.Mausoleum.ClearCrypt           = true
...
--[[ ACT 2 ]]--
Config.Scripts.Radament.Enabled 			  = false

Config.Scripts.Coldworm.Enabled 			  = false
Config.Scripts.Coldworm.KillBeetleburst 	  = false
Config.Scripts.Coldworm.ClearMaggotLair1 	  = false
Config.Scripts.Coldworm.ClearMaggotLair2 	  = false
Config.Scripts.Coldworm.ClearMaggotLair3 	  = false
...
Config.Scripts.ChestMania.Act3                = {79}
...
--[[ ACT 4 ]]--
Config.Scripts.OuterSteppes.Enabled 		  = false

Config.Scripts.Izual.Enabled 				  = false
...
Config.CainID.Enabled = false -- Identify items at Cain
...
Config.FieldID.MinSell = 20000 -- bot is not drop item that is sell more big this price
Config.FieldID.FastPick 				= true 		-- use for own risk if you are died because this is run for inside so much monster no complain!
Config.FieldID.MonsterRadius 			= 5       	-- What radius around the player to take in account for monsters count.
Config.FieldID.MonsterThreshold 		= 5 		-- If is more monster for close MonsterRadius bot is NOT ID item

Config.DroppedItemsLog.Enabled = false	-- Announce Dropped Items to in-game newbs
Config.DroppedItemsLog.Quality = { -- Quality of item to announce. 
...
Config.Sorceress.CastStatic     = 62    -- Cast static until the target is at designated life percent. | 100 = disabled
Config.Sorceress.CastStaticType		= 0x0  -- What kind of monsters to use static on. [0x0 = all | 0x7 = champion + unique + boss | 0xF = unique + boss]
...
Config.SafeCastEnabled          = true   -- Whether SafeCast is enabled or not. ONLY WORKS FOR SORCERESS
Config.SafeCastRadius           = 5       -- What radius around the player to take in account for monsters count.
Config.SafeCastMonsterThreshold = 5      -- How many monsters has to be in the SafeCastRadius to trigger a re-position. This is weigthed against your HP. [5 = Low Gear | 10 = CTA or MaxBlock | 15 = CTA and MaxBlock]
...
Config.DodgeMonsterRange  = 10       -- How close a monster can get before dodging. [Nova: 6 | Otherwise: 10]
